...
public interface TestCaseExecutionRepository extends JpaRepository<TestCaseExecution, UUID> {
    List<TestCaseExecution> getByTestPlanId(String testPlanId);
    List<TestCaseExecution> findByApplicationId(String appId);
    List<TestCaseExecution> findByMilestoneId(String milestoneId);
}
